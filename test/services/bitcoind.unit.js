...
describe('Bitcoin Service', function() {
  ...
  describe('#subscribeAddress', function() {
    ...
    it('will add a valid address', function() {
      var bitcoind = new BitcoinService(baseConfig);
      var emitter = new EventEmitter();
      bitcoind.subscribeAddress(emitter, ['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      should.exist(bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
    });
    it('will handle multiple address subscribers', function() {
      var bitcoind = new BitcoinService(baseConfig);
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      bitcoind.subscribeAddress(emitter1, ['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      bitcoind.subscribeAddress(emitter2, ['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      should.exist(bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'].length.should.equal(2);
    });
    it('will not add the same emitter twice', function() {
      ...
      bitcoind.subscribeAddress(emitter1, ['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      should.exist(bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'].length.should.equal(1);
    });
  });
  ...
  describe('#unsubscribeAddress', function() {
    ...
    it('it will remove a subscription', function() {
      ...
      should.exist(bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'].length.should.equal(2);
      bitcoind.unsubscribeAddress(emitter1, ['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'].length.should.equal(1);
    });
    it('will unsubscribe subscriptions for an emitter', function() {
      ...
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'] = [emitter1, emitter2];
    ...
    it('will NOT unsubscribe subscription with missing address', function() {
      ...
      var emitter2 = new EventEmitter();
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'] = [emitter1, emitter2];
      bitcoind.unsubscribeAddress(emitter1, ['PSHaqGdC1eAbahBwRiK9EyGDN2JykKmfBx']);
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'].length.should.equal(2);
    });
    it('will NOT unsubscribe subscription with missing emitter', function() {
      ...
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'] = [emitter2];
      bitcoind.unsubscribeAddress(emitter1, ['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'].length.should.equal(1);
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'][0].should.equal(emitter2);
    });
    it('will remove empty addresses', function() {
      ...
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'] = [emitter1, emitter2];
      bitcoind.unsubscribeAddress(emitter1, ['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      bitcoind.unsubscribeAddress(emitter2, ['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
      should.not.exist(bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87']);
    });
    it('will unsubscribe emitter for all addresses', function() {
      ...
      var emitter2 = new EventEmitter();
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'] = [emitter1, emitter2];
      bitcoind.subscriptions.address['PSHaqGdC1eAbahBwRiK9EyGDN2JykKmfBx'] = [emitter1, emitter2];
      sinon.spy(bitcoind, 'unsubscribeAddressAll');
      bitcoind.unsubscribeAddress(emitter1);
      bitcoind.unsubscribeAddressAll.callCount.should.equal(1);
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'].length.should.equal(1);
      bitcoind.subscriptions.address['PSHaqGdC1eAbahBwRiK9EyGDN2JykKmfBx'].length.should.equal(1);
    });
  });
  ...
  describe('#unsubscribeAddressAll', function() {
    ...
    it('will unsubscribe emitter for all addresses', function() {
      ...
      bitcoind.subscriptions.address['5JH1a2UCJVLAy6ucEdP4HqWN2j4dopUXaA'] = [emitter1];
      bitcoind.unsubscribeAddress(emitter1);
      bitcoind.subscriptions.address['qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87'].length.should.equal(1);
      bitcoind.subscriptions.address['PSHaqGdC1eAbahBwRiK9EyGDN2JykKmfBx'].length.should.equal(1);
      bitcoind.subscriptions.address['mgY65WSfEmsyYaYPQaXhmXMeBhwp4EcsQW'].length.should.equal(1);
      should.not.exist(bitcoind.subscriptions.address['5JH1a2UCJVLAy6ucEdP4HqWN2j4dopUXaA']);
    });
  });
  ...
  describe('#_wrapRPCError', function() {
    it('will convert paccoind-rpc error object into JavaScript error', function() {
      var bitcoind = new BitcoinService(baseConfig);
  ...
  describe('#_getDefaultConf', function() {
    ...
    it('will get default rpc port for livenet', function() {
      ...
      bitcoind._getDefaultConf().rpcport.should.equal(7111);
    });
    it('will get default rpc port for testnet', function() {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getDefaultConf().rpcport.should.equal(17111);
    });
  ...
  describe('#_getNetworkConfigPath', function() {
    ...
    it('will get default rpc port for testnet', function() {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getNetworkConfigPath().should.equal('testnet3/paccoin.conf');
    });
    it('will get default rpc port for regtest', function() {
      bitcore.Networks.enableRegtest();
      var config = {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getNetworkConfigPath().should.equal('regtest/paccoin.conf');
    });
  });
  ...
  describe('#_getAddressesFromTransaction', function() {
    it('will get results using bitcore.Transaction', function() {
      ...
      var outputAddress = bitcore.Address('qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87');
    ...
    it('will return unique values', function() {
      var bitcoind = new BitcoinService(baseConfig);
      var tx = bitcore.Transaction();
      var address = bitcore.Address('qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87');
      tx.addOutput(bitcore.Transaction.Output({
  ...
  describe('#_notifyAddressTxidSubscribers', function() {
    it('will emit event if matching addresses', function(done) {
      var bitcoind = new BitcoinService(baseConfig);
      var address = 'PSHaqGdC1eAbahBwRiK9EyGDN2JykKmfBx';
  ...
  describe('#getAddressUnspentOutputs', function() {
    ...
    it('will give results from client getaddressutxos', function(done) {
      ...
      var expectedUtxos = [
        {
          address: 'PSHaqGdC1eAbahBwRiK9EyGDN2JykKmfBx',
      ...
      var expectedUtxos = [
        {
          ...
          outputIndex: 1,
          satoshis: 400000,
          script: '76a914c21e8ab3e0e484b8cccaf93f4c340265655d226988ac',
          timestamp: 1461342954813,
          txid: 'f71bccef3a8f5609c7f016154922adbfe0194a96fb17a798c24077c18d0a9345'
        },
        {
    ...
    it('spending utxos in the mempool', function(done) {
      ...
      bitcoind.getAddressUnspentOutputs(address, options, function(err, utxos) {
        ...
        utxos[0].script.should.equal('76a914c21e8ab3e0e484b8cccaf93f4c340265655d226988ac');
  ...
  describe('#_getAddressStrings', function() {
    it('will get address strings from bitcore addresses', function() {
      var addresses = [
        bitcore.Address('PAkJKRzEy1noqV2sD8zzatJE2J1JomCNrY'),
        bitcore.Address('5JH1a2UCJVLAy6ucEdP4HqWN2j4dopUXaA'),
      ];
      var bitcoind = new BitcoinService(baseConfig);
      var strings = bitcoind._getAddressStrings(addresses);
      strings[0].should.equal('PAkJKRzEy1noqV2sD8zzatJE2J1JomCNrY');
      strings[1].should.equal('5JH1a2UCJVLAy6ucEdP4HqWN2j4dopUXaA');
    });
  ...
  describe('#getAddressHistory', function() {
    var address = 'PGEnupYxHcRKaGimeNwuXXpe1Fo9fNG1cU';
  ...
  describe('#_maybeGetBlockHash', function() {
    it('will not get block hash with an address', function(done) {
      ...
      bitcoind._maybeGetBlockHash('qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87', function(err, hash) {
        if (err) {
          return done(err);
        }
        getBlockHash.callCount.should.equal(0);
        hash.should.equal('qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87');
        done();
      });
    });
  ...
  describe('#govObject', function() {
    ...
    it('will call client gobject get and give result', function(done) {
      ...
      var gobject = sinon.stub().callsArgWith(2, null, {
        result: {
          "DataHex": "",
          "DataString": "[[\"proposal\",{\"end_epoch\":1483855193,\"name\":\"7ea9acff5ae83d8c9e217d30a2b4d10ef8f171f8\",\"payment_address\":\"qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87\",\"payment_amount\":84,\"start_epoch\":1483765282,\"type\":1,\"url\":\"https://www.paccoin.net\"}]]",
          "Hash": "4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00",
      ...
      bitcoind.govObjectHash('4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00', function(err, result) {
        ...
        should.equal(DataObject.payment_address, 'qb8B1ZZBixnYwKx8bW76TxMwL6NoiCWk87');
        should.equal(DataObject.payment_amount, 84);
        should.equal(DataObject.start_epoch, 1483765282);
        should.equal(DataObject.type, 1);
        should.equal(DataObject.url, 'https://www.paccoin.net');
        done();
      });
    });
  ...
  describe('#getMNList', function(){
    it('will call client masternode list and give result', function(done){
		    ...
		    client: {
			    masternodelist: function(type, cb){
			      switch (type){
                      ...
                      case "payee":
	                      return cb(null, { result:
		                      { '06c4c53b64019a021e8597c19e40807038cab4cd422ca9241db82aa19887354b-0': "PJVNMpF8KAw4aETqR9zi1ZV619z51x5xXb",
			                      'b76bafae974b80204e79858eb62aedec41159519c90d23f811cca1eca40f2e4c-1': "PBDdepxzXABhZenspv3RseG5dTbScg3fHn"}
	                      });
				      case "lastseen":
					      return cb(null, { result:
				      ...
				      case "addr":
					      return cb(null, { result:
						      { '06c4c53b64019a021e8597c19e40807038cab4cd422ca9241db82aa19887354b-0': "108.61.209.47:7112",
							      'b76bafae974b80204e79858eb62aedec41159519c90d23f811cca1eca40f2e4c-1': "34.226.228.73:7112"}
					      });
				      case "status":
					      return cb(null, { result:
	    ...
	    bitcoind.getMNList(function(err, MNList) {
		    ...
		    MNList[0].ip.should.equal("108.61.209.47:7112");
		    MNList[0].protocol.should.equal(70206);
		    MNList[0].payee.should.equal("PJVNMpF8KAw4aETqR9zi1ZV619z51x5xXb");
